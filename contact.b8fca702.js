...
_theme.soilTheme.init();
_nav.soilNav.init();
const mainFooter = document.querySelector('#main-footer');
mainFooter.innerText = `Mieczysław Palian ${new Date().getFullYear()}`;

},{"./theme":"32JT5","./nav":"fNybC"}],"32JT5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "soilTheme", ()=>soilTheme
);
...
},{}],"fNybC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "soilNav", ()=>soilNav
);
